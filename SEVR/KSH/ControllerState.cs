    ...
    public class ControllerState
    {
        ...
        public void Update(CVRSystem system, uint id)
        {
            if (id == 999)
                return;
            //is pressed
            system.GetControllerState(id, ref m_controllerState, (uint) System.Runtime.InteropServices.Marshal.SizeOf(m_controllerState));
            //was pressed
        ...
        public bool GetTouchpadXY(ref Vector2 pos)
        {
            ...
            {
                pos.X = m_controllerState.rAxis0.x;
                pos.Y = m_controllerState.rAxis0.y;
                return true;
            }
            return false;
        }
        ...
        {
            return m_controllerState.rAxis1.x;//0...1
        }
    }
#endif // !XB1
}
